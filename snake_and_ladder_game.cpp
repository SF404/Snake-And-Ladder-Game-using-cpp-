//********Important*********
//press any char to roll a dice
//If you get 6 you have 1 moce dice roll
//If you get 6 more than 2 times your current roll becomes zero
...
int main()
{
    ...
    while (1)
    {
        for (int i = 0; i < n; i++)
        {
            ...
            if (p[i].score == 100) // when a player reaches finish point
            {
